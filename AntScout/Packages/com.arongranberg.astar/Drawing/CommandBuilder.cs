...
namespace Pathfinding.Drawing {
	...
	public partial struct CommandBuilder : IDisposable {
		...
		/// <summary>\copydocref{Label2D(float3,ref FixedString32Bytes,float)}</summary>
		...
		/// <summary>\copydocref{Label2D(float3,ref FixedString32Bytes,float,LabelAlignment)}</summary>
		...
		/// <summary>\copydocref{Label3D(float3,quaternion,ref FixedString32Bytes,float)}</summary>
		...
		/// <summary>\copydocref{Label3D(float3,quaternion,ref FixedString32Bytes,float,LabelAlignment)}</summary>
